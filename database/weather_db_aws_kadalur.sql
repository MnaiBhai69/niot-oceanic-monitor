...
--
-- Table structure for table `aws_kadalur`
--

DROP TABLE IF EXISTS `aws_kadalur`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aws_kadalur` (
...
--
-- Dumping data for table `aws_kadalur`
--

LOCK TABLES `aws_kadalur` WRITE;
/*!40000 ALTER TABLE `aws_kadalur` DISABLE KEYS */;
/*!40000 ALTER TABLE `aws_kadalur` ENABLE KEYS */;
UNLOCK TABLES;
