...
--
-- Table structure for table `aws_kanyakumari`
--

DROP TABLE IF EXISTS `aws_kanyakumari`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aws_kanyakumari` (
...
--
-- Dumping data for table `aws_kanyakumari`
--

LOCK TABLES `aws_kanyakumari` WRITE;
/*!40000 ALTER TABLE `aws_kanyakumari` DISABLE KEYS */;
INSERT INTO `aws_kanyakumari` VALUES (1,'2026-04-27 19:02:02',12.92,1007.79,35.28,23.37,47.98,680.69,491.5,29.747,30.322,0,0,0,1.85,131,308.4,12.9454,80.2117,25.9,109,5,18);
/*!40000 ALTER TABLE `aws_kanyakumari` ENABLE KEYS */;
UNLOCK TABLES;
