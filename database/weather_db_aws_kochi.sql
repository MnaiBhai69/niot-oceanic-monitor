...
--
-- Table structure for table `aws_kochi`
--

DROP TABLE IF EXISTS `aws_kochi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aws_kochi` (
...
--
-- Dumping data for table `aws_kochi`
--

LOCK TABLES `aws_kochi` WRITE;
/*!40000 ALTER TABLE `aws_kochi` DISABLE KEYS */;
/*!40000 ALTER TABLE `aws_kochi` ENABLE KEYS */;
UNLOCK TABLES;
